...
public class ComposedKeyDataHandlingTest {
    ...
    private static final Logger logger = Logger
            .getLogger(ComposedKeyDataHandlingTest.class);
    ...
    public void singleInsertion() {
        ...
        cassandraUtils
                .executeQuery(
                        queryUtils
                                .constructDeleteQueryByCondition("integer_1 = 4 and ascii_1 = 'ascii'"),
                        true);
        ...
        cassandraUtils
                .executeQuery(
                        queryUtils
                                .constructDeleteQueryByCondition("integer_1 = 5 and ascii_1 = 'ascii'"),
                        true);
        ...
        cassandraUtils
                .executeQuery(
                        queryUtils
                                .constructDeleteQueryByCondition("integer_1 = 2 and ascii_1 = 'ascii'"),
                        true);
        ...
        cassandraUtils
                .executeQuery(
                        queryUtils
                                .constructDeleteQueryByCondition("integer_1 = 3 and ascii_1 = 'ascii'"),
                        true);
