...
public class UDTIndexing {
    ...
    public static void before() {
        ...
        cassandraUtils = CassandraUtils.builder().withTable(TestingConstants.TABLE_NAME_CONSTANT).build();
    ...
    public void testUDTMap() {
        CassandraUtilsSelect select = cassandraUtils.filter(match("addres.zips_map.1", "1A"));
        assertEqualsAndOnlyThisString(select.stringColumn("login"), new String[]{"USER1", "USER3", "USER5", "USER7"});
    ...
    public void testUDTMapThatFails() {
        ...
        CassandraUtilsSelect select = cassandraUtils.filter(match("addres.zips_map", "1A"));
        assertEqualsAndOnlyThisString(select.stringColumn("login"), new String[]{});
    }
