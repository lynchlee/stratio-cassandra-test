...
public class AllowFilteringWith1000MixedRowsTest extends
        Abstract1000RegistersWatchedTest {

    private static final Logger logger = Logger
            .getLogger(AllowFilteringWith1000MixedRowsTest.class);
    ...
    public static void setUpSuite() {
        ...
        queriesList.addAll(VariaDataHelper.generateCustomInsertionsWithModule(
                1000, 4, queryUtils));
